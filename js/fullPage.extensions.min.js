...
!(function (n, t) {
  ...
  var Nt = function (n) {
    ...
    Pt = function (n, t) {
      (this.parent = this.parent || null),
        (this.selector = t),
        (this.anchor =
          Z(n, "data-anchor") || Mt().anchors[T(n, Mt().sectionSelector)]),
        (this.item = n),
        (this.isVisible = d(n)),
  ...
  function De() {
    var n =
      p(".fp-auto-height")[0] || ($e() && p(".fp-auto-height-responsive")[0]);
    Mt().lazyLoading &&
      n &&
    ...
    (e = n),
      Mt().menu &&
        ...
        p(Mt().menu).forEach(function (n) {
          null != n &&
            (R(p(Un, n), Yn), E(p('[data-menuanchor="' + e + '"]', n), Yn));
        }),
      (function (n, t) {
        var e = p(Kn)[0];
        Mt().navigation &&
        ...
        function (n) {
          ...
          (ai = t),
            X(Mt().onScrollOverflow) &&
              re("onScrollOverflow", { position: t, direction: e }),
            g(n.target, at) &&
              vn.canScroll &&
              li.Pn(e, n.target) &&
              li.Hn() &&
  ...
  function Hi() {
    ...
    n || (!Mt().loopBottom && !Mt().continuousVertical) || (n = hn().N[0]),
      null != n
        ? Ue(n, null, !1)
        : yt().scrollHeight < $t.scrollHeight &&
          Mt().scrollBar &&
          Mt().Zn &&
          dn.L(Ln);
  }
              ...
              if (u || (!t && l)) {
                ...
                var c = (function (n) {
                    var t,
                      ...
                      i = [],
                      o = Zt(
                        (vn.P && vn.P.activeSlide ? vn.P.activeSlide : vn.P)[
                          e
                        ]()
                      );
                    do {
                      (i = wo(o.item)).length &&
                        (t = { Yn: o, Un: i[n ? i.length - 1 : 0] }),
                        (o = Zt(o[e]()));
                    } while (o && 0 === i.length);
                    return t;
                  })(u),
  ...
  function Mo(n) {
    var t = new Date().getTime(),
      ...
      i = (function (n, t) {
        new Date().getTime();
        var e =
            hn().C && n.getBoundingClientRect().bottom >= 0 && "up" === Ei.Fn(),
          i = hn().Vn;
        if (i) return V(t), !1;
        if (hn().C) {
          if (e) {
            ...
            if (Ei.Wn())
              return (
                (e = !1), pn({ Vn: !0 }), pn({ H: "wheel" }), ji(), V(t), !1
              );
          } else Pi("set", "beyondFullpage", 1e3);
          if (!i && !e) return !0;
        }
      })(yt(), n);
    if ((vn._ || pn({ X: !1, _: !0, Y: "none" }), !Se().m.down && !Se().m.up))
      return V(n), !1;
    if (i) return !0;
    if (!1 === i) return V(n), !1;
            ...
            .forEach(function (n) {
              if (!e) {
                var t = Q(i, n),
                  o = P(i, n);
                (t || o) &&
                  (s.shared._n || xo(!1), (s.shared._n = !0), (e = !0));
              }
            }),
      ...
      dn.R(Sn, function () {
        ...
        pn({
          Kn:
            ...
            ((l || u) &&
              ((l && e <= l.qn && l.nt === t.split(n[0])[4]) || u || l.$n)) ||
              !1),
        });
      });
      var n = ["-"],
        ...
        n &&
          ...
          Ht(hn().un).forEach(function (n) {
            Mt().scrollOverflow && li.Nn(n),
              R(n, "fp-table active fp-completely " + ut);
